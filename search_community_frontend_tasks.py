...
# Search for Phase 3 Frontend tasks (community-related)
result = supabase.table('project_grid_tasks_revised').select('*').eq('phase', 3).order('task_id').execute()

print("Phase 3 tasks (all):\n")
