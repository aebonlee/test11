...
**생성할 파일:**
1. `lib/utils/image-upload.ts` - 이미지 업로드 헬퍼
...
**허용 이미지 포맷:** jpg, jpeg, png, webp, gif (최대 5MB)
...
**Storage 경로:** `avatars/{userId}/`, `politician-images/{politicianId}/`
...
**절대 경로 별칭**: `@/` (예: `import ... from '@/lib/utils/image-upload'`)
