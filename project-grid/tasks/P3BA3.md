...
이 작업을 시작하기 전에 다음 작업이 완료되어야 합니다: P2D1, P1BA3

---

## 📦 기대 결과물

- app/api/auth/signin/route.ts (Mock → Real 교체)
