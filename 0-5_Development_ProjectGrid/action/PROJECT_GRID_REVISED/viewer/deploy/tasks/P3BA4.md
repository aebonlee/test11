...
이 작업을 시작하기 전에 다음 작업이 완료되어야 합니다: P2D1, P1BA4

---

## 📦 기대 결과물

- app/api/auth/reset-password/route.ts (Mock → Real 교체)
...
- [ ] 비밀번호 재설정 API (Real) 기능이 정상적으로 구현됨
- [ ] 기대 결과물이 모두 생성됨
- [ ] 코드가 정상적으로 빌드/실행됨
- [ ] 타입 체크 및 린트 통과
