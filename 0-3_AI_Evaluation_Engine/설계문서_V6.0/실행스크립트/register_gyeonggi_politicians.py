...
def load_candidates():
    """JSON 파일에서 후보자 정보 로드"""
    file_path = os.path.join(os.path.dirname(__file__), '..', 'gyeonggi_governor_candidates_new_10.json')
...
def main():
    ...
    if registered:
        ...
        mapping_file = os.path.join(os.path.dirname(__file__), '..', 'gyeonggi_politician_ids.txt')
