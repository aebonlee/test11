...
# -*- coding: utf-8 -*-
"""
일관성 낮은 정치인 2명 풀링 시스템 테스트
- 금태섭, 안철수 선택 (김동연 다음으로 일관성 낮은 정치인들)
"""
import os
import sys
...
# 테스트할 정치인 2명
TEST_POLITICIANS = [
    {'id': 'de49f056', 'name': '금태섭'},
    {'id': 'eeefba98', 'name': '안철수'}
]
...
def main():
    print("="*80)
    print("일관성 낮은 정치인 2명 풀링 시스템 테스트")
    print("="*80)
    ...
    # 저장
    with open('pooling_test_2_politicians_results.json', 'w', encoding='utf-8') as f:
        json.dump(results, f, ensure_ascii=False, indent=2)

    print(f"\n결과 저장: pooling_test_2_politicians_results.json")
